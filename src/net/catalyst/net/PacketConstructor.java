...
public class PacketConstructor {
	 ...
	 */
	public PacketConstructor setBare(boolean bare) {
		this.bare = bare;
		return this;
	}
	 ...
	 */
	public PacketConstructor addBits(int value, int numBits) {
	 ...
	 */
	public PacketConstructor addBytes(byte[] data) {
	 ...
	 * @return A reference to this object
	 */
	public PacketConstructor addBytes(byte[] data, int offset, int len) {
	 ...
	 * @return A reference to this object
	 */
	public PacketConstructor addByte(byte val) {
	 ...
	 * @return A reference to this object
	 */
	public PacketConstructor addShort(int val) {
	 ...
	 * @return A reference to this object
	 */
	public PacketConstructor addInt(int val) {
	 ...
	 * @return A reference to this object
	 */
	public PacketConstructor addLong(long val) {
		addInt((int) (val >> 32));
		addInt((int) (val & -1L));
		return this;
	}
	...
	public Packet toPacket() {
		...
		return new Packet(null, data, bare, -1);
	}
}